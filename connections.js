...
let series1 = [
  "Expressing feelings calmly, I am disappointed because...",
  "Seeking comfort",
  "Taking deep breaths to manage emotions",
  "Keeping a calm posture to show acceptance",
];
let series2 = [
  "Saying: I understand how you feel...",
  "Offering support, If you need anything, I am here",
  "Maintaining eye contact to show you are listening",
  "Gentle nods to show understanding and empathy",
];
let series3 = [
  'Saying "Thank you for the feedback.',
  "Asking clarifying questions to understand better",
  "Maintaining a neutral expression to show openness",
  "Nodding to show you are listening and taking it seriously",
];
let series4 = [
  "Using enthusiastic tone",
  "Sharing your feelings: This makes me really happy!",
  "Clapping hands or jumping slightly to show excitement",
